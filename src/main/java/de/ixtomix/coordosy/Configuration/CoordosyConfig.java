...
public class CoordosyConfig {
    ...
    private static void setupBasicConfig() {
        ...
        AGGRESSIVE_MODE = CLIENT_BUILDER.comment("true if Coordosy shall scan for other Players in Minecraft itself, false means only sending your own Coordinates to API-Endpoint")
